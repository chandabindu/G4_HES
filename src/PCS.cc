...
////////////////////////////////////////////////////////////////
G4VPhysicalVolume *PCS::PlaceOLD( G4VPhysicalVolume *pMother )
////////////////////////////////////////////////////////////////
{
  G4Box* PCSbox = new G4Box( "PCSbox", 50.*cm, 50.*cm, 50.*cm);

  G4LogicalVolume* PCSboxLV = new G4LogicalVolume( PCSbox, mYoke_, "PCSboxLV");

  G4VPhysicalVolume *PCSMag = new G4PVPlacement( &rotMtx_, gPos_, "PCS", PCSboxLV, pMother, false, 0);

  ///////////////////
  // Visualisation //
  ///////////////////
  G4VisAttributes* PCSboxVisAtt = new G4VisAttributes(G4Color(1,0,0));
  PCSboxLV-> SetVisAttributes(PCSboxVisAtt);

  solidField = new G4Box( "PCS field", 50.*cm, 50.*cm, 50.*cm );
