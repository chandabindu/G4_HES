...
//#include "/usr/local/include/CLHEP/Random/RandGaussQ.h"
...
///////////////////////////////////
bool DFieldMan::Initialize( void )
///////////////////////////////////
{
  static const std::string funcname = "DFieldMan::Initialize";
  FILE *fp;
  char str[MaxChar];
  ...
  while( fgets(str,MaxChar,fp)!=0){
	...
	if( ix<0 || ix>=Nx || iy<0 || iy>=Ny || iz<0 || iz>=Nz ){
	  std::string mes=str;
	  std::cerr << "[" << funcname << "]: Invalid Range ==> " << std::endl;
...
////////////////////////////////////////////////////////////////////////////
bool DFieldMan::GetFieldValue( const double point[3], double *Bfield ) const
////////////////////////////////////////////////////////////////////////////
{
  static const std::string funcname = "DFieldMan::GetFieldValue";
...
////////////////////////////////////////////////////////
double DFieldMan::GetReff( double, double ) const
////////////////////////////////////////////////////////
{
...
//////////////////////////////////
void DFieldMan::cleanupMap( void )
//////////////////////////////////
{
  for( int ix=0; ix<Nx; ++ix ){
    for( int iy=0; iy<Ny; ++iy ){
