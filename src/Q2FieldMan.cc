...
///////////////////////////////////
bool Q2FieldMan::Initialize( void )
///////////////////////////////////
{
  static const std::string funcname = "Q2FieldMan::Initialize";
  FILE *fp;
  char str[MaxChar];
...
/////////////////////////////////////////////////////////////
{
  static const std::string funcname = "Q2FieldMan::GetFieldValue";
  double xt = point[0];
  double zt = point[2];
  double yt = point[1];
  int Xflag = 1;
...
/////////////////////////////////////////////////////////
double Q2FieldMan::GetReff( double, double) const
////////////////////////////////////////////////////////
{
...
///////////////////////////////////
void Q2FieldMan::cleanupMap( void )
///////////////////////////////////
{
  for( int ix=0; ix<Nx; ++ix ){
    for( int iy=0; iy<Ny; ++iy ){
