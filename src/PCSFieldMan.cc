...
///////////////////////////////////
bool PCSFieldMan::Initialize( void )
//////////////////////////////////
{
  static const std::string funcname = "PCSFieldMan::Initialize";
  FILE *fp;
  char str[MaxChar];
...
//////////////////////////////////////////////////////////////
bool PCSFieldMan::GetFieldValue( const double point[3], double *Bfield ) const
//////////////////////////////////////////////////////////////
{
  static const std::string funcname = "PCSFieldMan::GetFieldValue";
...
/////////////////////////////////////////////////////////
double PCSFieldMan::GetReff( double, double) const
////////////////////////////////////////////////////////
{
...
///////////////////////////////////
void PCSFieldMan::cleanupMap( void )
///////////////////////////////////
{
  for( int ix=0; ix<Nx; ++ix ){
    for( int iy=0; iy<Ny; ++iy ){
